...
public class InstanceCreationVisitor extends MethodVisitor {
    ...
    public void visitMethodInsn(int opcode, String owner, String name,
        ...
        /* Obtain and load class constant (of created object) pn stack */
        mv.visitInsn(Opcodes.DUP);
        mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL,
                currentElem.type.getInternalName(), "getClass",
                Type.getMethodDescriptor(Type.getType(Class.class)));
        
        /*
         * The operation below is not supported by some older JVM versions
         * due to inability to load class constants on stack and was
         * reimplemented above.
         * 
         * Suggested by: http://mail-archive.ow2.org/asm/2009-06/msg00011.html
         * 
         * The outputs (with and without the validation error) of the command
         * "mvn -e test &> <output*>", the generated bytecode and a diff file
         * are available in the ${basedir}/doc/class-constants-issue directory.
         * 
