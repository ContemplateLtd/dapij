 ...
 * increments an instance variable (insnOfst) in each of them. This provides
 * an instruction offset value for each instruction as it is being visited.
 * Values range from 0 starting at the beginning of the method 0 to N, where
 * N is the number of instructions in that method.
 *
