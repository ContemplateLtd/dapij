 ...
 * {@link InstructionOffsetVisitor} (another {@link MethodVisitor}).
 *
 * @author Nikolay Pulev <N.Pulev@sms.ed.ac.uk>
 */
public class InstructionOffsetReader extends MethodVisitor {

    private InstructionOffsetVisitor iop;
    ...
    /**
     * A reference to a {@link InstructionOffsetVisitor} has to be passed to
     ...
     */
    public final void setInsnOfsetProvider(InstructionOffsetVisitor iop) {
        this.iop = iop;
    }

    protected final int getInsnOfst() {
        if (iop == null) {
            throw new RuntimeException("A " + InstructionOffsetVisitor.class.getName()
